---
title: Руководства
description: Руководства — это уроки, которые за руку ведут читателя через последовательность шагов до завершения какого-то проекта. Руководства ориентированы на обучение.
