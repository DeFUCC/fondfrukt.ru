...
.fixed.top-4.left-2.z-200 
  ...
  transition(name="fade")
    .rounded-lg.shadow-lg.absolute.top-18.left-4.z-20.gap-2.flex.flex-col.py-6.px-4.text-left.gap-1.bg-light-500.dark_bg-dark-100.min-w-xs.max-h-90vh.overflow-y-scroll.leading-relaxed.text-md(
      v-if="open"
      ref="target"
      )
